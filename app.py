...
# ユーザーインターフェイスの構築
st.title("サメAI")
st.write("サメさんと対話ができる魔法のチャットボットです。")
